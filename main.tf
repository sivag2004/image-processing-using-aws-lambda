...
locals {
  ...
  upload_bucket_name = "${local.bucket_prefix}-uploads-${random_id.suffix.hex}"
...
data "archive_file" "lambda_zip" {
    type = "zip" 
    source_file = "${path.module}/../lambda/lambda_function.zip"
...
resource "aws_cloudwatch_log_group" "lambda_processsor" {
